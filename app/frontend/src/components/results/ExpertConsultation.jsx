                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <a href="mailto:torstenschenk364@gmail.com" className="text-white text-sm font-semibold hover:text-indigo-300 transition-colors">
                                                    torstenschenk364@gmail.com
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <a href="tel:+49 XXXX XXXX" className="text-white text-sm font-semibold hover:text-indigo-300 transition-colors">
                                                    +49 XXXX XXXX
                                                </a>
                                            </div>
                                        </div>
