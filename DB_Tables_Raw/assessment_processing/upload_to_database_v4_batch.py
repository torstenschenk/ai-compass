...
def insert_data_batch():
    """Insert data using execute_batch for performance."""
    ...
    print(f"Prepared {len(responses_data)} responses and {len(response_items_data)} items.")
    ...
    # Batch Insert Items
    print("Inserting response items...")
    extras.execute_batch(cur, """
